...
class FormField(BaseModel):
    ...
    choices: Optional[List[str]] = Field(None, description="Choices for dropdown/radio fields")
    max_length: Optional[int] = Field(None, description="Maximum text length")
    multiline: bool = Field(False, description="Whether text field is multiline")
    readonly: bool = Field(False, description="Whether field is readonly")
